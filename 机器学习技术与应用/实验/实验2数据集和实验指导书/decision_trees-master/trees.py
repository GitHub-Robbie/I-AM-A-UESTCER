...
def cal_shannon_ent(dataset):
    ...
    for feat_vec in dataset:
        ...
        # 如果label不在字典中，则创建key，并赋值为0;否则，加1
...
if __name__ == '__main__':
    ...
    predict = classify(lenses_tree, labels, ['pre','myope','no','normal'])
    print("Result: ")
    print(predict)
    store_tree(lenses_tree,"classifierStorage.txt")
    treePlotter.create_plot(lenses_tree)
    tree_grab = grab_tree("classifierStorage.txt")
    print("Reload Result: ")
    print(tree_grab)
