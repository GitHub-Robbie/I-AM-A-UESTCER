public class StringTest1 {
	public static void main(String args[]) {
		...
		(s1 == s2));// the same string, different memory
		System.out.println(s1 + " == " + s3 + " -> " + 
		(s1 == s3));// the same string and memory

		System.out.println("****************************");

		System.out.println(s1 + " compare to " + s2 + " -> " + s1.compareTo(s2));// equals return true
		System.out.println(s1 + " compare to " + s4 + " -> " + s1.compareTo(s4));
		System.out.println(s1 + " compare to " + s5 + " -> " + s1.compareTo(s5));
