...
void Goodsprint(GoodsList *p){
	printf("----------------------------");
	printf("ID: %s\tName: %s\tPrice: %s\tDiscount: %s\tAmount: %s\tRemain: %s\t", 
	GoodsList.data.goods_id, GoodsList.data.goods_name, GoodsList.data.goods_price,
	GoodsList.data.goods_discount, GoodsList.data.goods_amount, GoodsList.data.goods_remain);
	printf("----------------------------");
    /**
     * 1.打印单个链表商品结点的信息
     */
